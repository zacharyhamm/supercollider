> **Personal fork notice:** This is a personal fork of SuperCollider that adds a Vim mode to the editor. It is not intended to be merged into the upstream SuperCollider main branch and is maintained solely for my own use. I will try to track upstream changes, but this fork may be substantially behind upstream at times.
